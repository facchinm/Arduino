...
public class ContributionManagerPluginsUI extends InstallerJDialog {

  private final ContributionInstaller installer;

  @Override
  protected FilteredAbstractTableModel createContribModel() {
    return new ContributionIndexPluginsTableModel();
  }

  private ContributionIndexPluginsTableModel getContribModel() {
    return (ContributionIndexPluginsTableModel) contribModel;
  }

  @Override
  protected TableCellRenderer createCellRenderer() {
    return new ContributedPluginTableCellRenderer();
  }

  @Override
  protected InstallerTableCell createCellEditor() {
    return new ContributedPluginTableCellEditor() {
      @Override
      protected void onInstall(ContributedPlugin selected,
      ...
      @Override
      protected void onRemove(ContributedPlugin installedPlugin) {
        onRemovePressed(installedPlugin, true);
      }
    };
  }

  public ContributionManagerPluginsUI(Frame parent, ContributionInstaller installer) {
    super(parent, tr("Plugins Manager"), Dialog.ModalityType.APPLICATION_MODAL,
  ...
  public void onInstallPressed(final ContributedPlugin platformToInstall,
                               final ContributedPlugin platformToRemove) {
    clearErrorMessage();
    installerThread = new Thread(() -> {
  ...
  public void onRemovePressed(final ContributedPlugin platform,
                              boolean showWarning) {
    clearErrorMessage();
