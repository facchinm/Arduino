...
public class ContributedPluginTableCellJPanel extends JPanel {
  ...
  public ContributedPluginTableCellJPanel() {
    super();
  ...
  void update(JTable parentTable, Object value, boolean isSelected,
    ...
    ContributedPluginReleases releases = (ContributedPluginReleases) value;
    ...
    ContributedPlugin selected = releases.getSelected();
    ContributedPlugin installed = releases.getInstalled();
